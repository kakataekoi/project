...
<body class="animsition">
    ...
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block ">
            <div class="logo">
                <a class="ml-5 font-weight-bold text-muted" href="{{ url('dashboard')}}">ZinHaHeng</a>
            </div>
    ...
    <footer>
        <div class="row">
            <div class="col-md-12">
                <div class="copyright">
                    <p> © made with ❤️ by <a href="https://pongsawadi.ac.th/psc2019/">สาขาเทคโนโลยีสารสนเทศ วิทยาลัยเทคโนโลยีพงษ์สวัสดิ์</a>.</p>
                </div>
            </div>
        </div>
    </footer>
